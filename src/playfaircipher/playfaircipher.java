...
public class playfaircipher {
 ...
 // it a promt that shows requirements and user input
 ...
 // replace some letters required for the codec operation
    public static String prepareText(String s, boolean changeJtoI) {
        s = s.toUpperCase().replaceAll("[^A-Z]", "");
        return changeJtoI ? s.replace("J", "I") : s.replace("Q", "");
    }
 //creating the table of letters 
 ...
 //encrypt the plaintext by calling the codec fuction
    ...
    // shows if the string content is number or no
 ...
 // gives the decryption by the call of codec function
     public static String decode(String s) {
        return codec(new StringBuilder(s), 4);
    }
 //fuction where the encode and decode operation happens
